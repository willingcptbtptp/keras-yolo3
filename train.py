...
def _main():
    ...
    log_dir = 'logs/001/'   # 在keras-yolo3/下新建这个文件夹
    ...
    if True:
        ...
        model.fit_generator(data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes),
                            ...
                            epochs=2000,  #源代码epoch是50
                            initial_epoch=0,
                            callbacks=[logging, checkpoint, reduce_lr, early_stopping])    #源码是[logging, checkpoint]也就是没哟逐步减小学习率
